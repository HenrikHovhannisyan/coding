...
recurse();`}
      />
      <h2 className="text-2xl mt-8 mb-4">Пример рекурсии</h2>
      <CodeExample
...
1`}
      ...
      <ul className="list-disc ms-4">
        <li>
          <p>
            Пользователь передает число в качестве аргумента при вызове функции.
            В нашем случае — 4.
          </p>
        </li>
        <li>
      ...
      <ul className="list-disc ms-4">
        <li>
          <p>
            ...
            аргументов, она рекурсивно вызывает саму себя, уменьшая число на 1.
          </p>
        </li>
        <li>
          <p>
            Этот процесс продолжается до тех пор, пока число не станет равным 1.
            Когда функция в очередной раз уменьшит число на 1, оно станет равно
            0. Факториал нуля — 1 → вернется единица.{" "}
          </p>
        </li>
      </ul>
      <img
